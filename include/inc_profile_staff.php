...
$err_address1 = $err_address2 = $err_address3 = $err_roll_no = "" ;
// -----
...
global $address1, $address2, $address3, $pin, $district, $state, $country, $blood_group, $roll_no, $dob;
...
$enable_log=true;
		...
		try {
			...
			user_type_id, mobile, phone, address1, address2, address3, pin, district, state, country, blood_group, roll_no, created_at)
			VALUES(:id, :year_of_admission, :email, :branch, :internal_id, :name, :dob, :password, :password_hash, :user_type_id, :mobile, :phone, :address1, :address2, :address3, 
			:pin, :district, :state, :country, :blood_group, :roll_no, :created_at)");
